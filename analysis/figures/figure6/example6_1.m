...
figure(h2);
% subplot('Position',[0.08 0.915-exw*Dy/Dx_-0.225*2 0.09 0.215]);
% plot(stot,stofe)
% hold on
% plot(stot,stofc);
...
axx = subplot('Position',[0.07 0.915-exw*Dy/Dx_-0.225*2 0.335 0.215]);
