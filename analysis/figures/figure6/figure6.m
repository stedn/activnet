...
ax2 = subplot('Position',[0.625,0.915-exw*Dy/Dx_-0.225,0.36,0.215]);
...
annotation('textbox', [0.52 0.68 0.05 0.05],'String','c)','LineStyle','none','FontSize',16,'FontName','Times','Color',[0.25 0.25 0.25])
